...
const Login = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-800 to-white-100'>
        <img onClick={()=>navigate('/')} src={assets.kaslogo1} alt="" className='absolute left-5 sm:left-20 top-5 w-10 sm:w-14 cursor-pointer'/>
